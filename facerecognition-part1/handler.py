...
try:
    ...
    s3.download_file(S3_BUCKET, PREDICTOR_PATH, "/tmp/shape_predictor_5_face_landmarks.dat")
    faceDetector = dlib.get_frontal_face_detector()
    landmarkDetector = dlib.shape_predictor("/tmp/shape_predictor_5_face_landmarks.dat")
